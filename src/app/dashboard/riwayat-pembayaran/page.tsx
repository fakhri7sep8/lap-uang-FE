      ...
      <section className="grid grid-cols-2 gap-4 ">
        <div className="rounded-xl p-9 bg-blue-400  text-white h-40 flex justify-between items-center shadow-md">
          <div className="flex flex-col gap-2">
            <h2 className="font-medium text-2xl">Pembayar Terbanyak</h2>
        ...
        <div className="rounded-xl bg-green-400 p-9 text-white h-40 flex justify-between items-center shadow-md">
          <div className="flex flex-col gap-2">
            <h2 className="font-medium text-2xl">Total Pembayaran SPP</h2>
        ...
        <div className="rounded-xl bg-violet-500 p-9 text-white h-40 flex justify-between items-center shadow-md">
          <div className="flex flex-col gap-2">
            <h2 className="font-medium text-2xl">Tanggal Pembayaran</h2>
            <p className="text-6xl font-medium">7</p>
          </div>
          <div className="bg-violet-100 rounded-full w-20 h-20 flex justify-center items-center">
            <CalendarClock size={32} className="text-violet-500" />
          </div>
        </div>
        <div className="rounded-xl bg-red-400 p-9 text-white h-40 flex justify-between items-center shadow-md">
          <div className="flex flex-col gap-2">
            <h2 className="font-medium text-2xl">Rata-rata Pembayaran </h2>
            <p className="text-6xl font-medium">3</p>
          </div>
          <div className="bg-red-100 rounded-full w-20 h-20 flex justify-center items-center">
            <BarChart3 size={32} className="text-red-700" />
          </div>
        </div>
      </section>
