...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      className={`${
        sidebarCollapsed ? "w-28 bg-red-500" : "w-64"
                    ...
                    <CollapsibleContent>
                      <SidebarMenuSub>
                        <SidebarMenuSubItem>
                          <SidebarMenuButton asChild>
                            <a href="#tambah-siswa">
                              <UserPlus className="mr-2" size={16} /> Tambah
                              Siswa
                            </a>
                          </SidebarMenuButton>
                          <SidebarMenuButton asChild>
                            <a href="#lihat-siswa">
                              <Users2 className="mr-2" size={16} /> Lihat Semua
                              Siswa
                            </a>
                          </SidebarMenuButton>
                        </SidebarMenuSubItem>
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuButton asChild>
                            <a href="#input-pembayaran">
                              <Banknote className="mr-2" size={16} /> Input
                              Pembayaran
                            </a>
                          </SidebarMenuButton>
                          <SidebarMenuButton asChild>
                            <a href="#riwayat-pembayaran">
                              <History className="mr-2" size={16} /> Riwayat
                              Pembayaran
                            </a>
                          </SidebarMenuButton>
                          <SidebarMenuButton asChild>
                    ...
                    <CollapsibleContent>
                      <SidebarMenuSub>
                        <SidebarMenuSubItem>
                          <SidebarMenuButton asChild>
                            <a href="#arus-kas">
                              <Activity className="mr-2" size={16} /> Laporan
                              Arus Kas
                            </a>
                          </SidebarMenuButton>
                          <SidebarMenuButton asChild>
                          ...
                          <SidebarMenuButton asChild>
                            <a href="#rekap-kwitansi">
                              <ClipboardList className="mr-2" size={16} /> Rekap
                              Kwitansi
                            </a>
                          </SidebarMenuButton>
                        </SidebarMenuSubItem>
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuButton asChild>
                            <a href="#profil-sekolah">
                              <School className="mr-2" size={16} /> Profil
                              Sekolah
                            </a>
                          </SidebarMenuButton>
                          <SidebarMenuButton asChild>
                            ...
                            >
                              <KeyRound className="mr-2" size={16} /> Ganti
                              Password
                            </button>
                          </SidebarMenuButton>
                        </SidebarMenuSubItem>
                    ...
                    <CollapsibleContent>
                      <SidebarMenuSub>
                        <SidebarMenuSubItem>
                          ...
                          <SidebarMenuButton asChild>
                            <a href="#tentang">
                              <Info className="mr-2" size={16} /> Tentang
                              Aplikasi
                            </a>
                          </SidebarMenuButton>
                        </SidebarMenuSubItem>
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem className="px-4 py-2 text-black hover:bg-white gap-2 cursor-pointer hover:font-semibold">
                    ...
                    <span className={`text-black ${poppins.className}`}>
                      Upgrade to Pro
                    </span>
                  </DropdownMenuItem>
                  {/* Account */}
